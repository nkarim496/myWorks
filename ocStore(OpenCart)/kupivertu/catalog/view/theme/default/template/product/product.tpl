...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
	...
	<h1><?php echo $heading_title; ?></h1>
	  ...
	  <img src="image/vertu-original.jpg" />
	  <img src="image/vertu-warranty.jpg" />
	  <img src="image/vertu-delivery.jpg" />
	  </div>
      <div class="cart">
        <div>
		  ...
		  <a onclick="addToWishList('<?php echo $product_id; ?>');"><?php echo $button_wishlist; ?></a>
            ...
            <div class="compare"><a onclick="addToCompare('<?php echo $product_id; ?>');"><?php echo $button_compare; ?></a></div></div>
        </div>
        <?php if ($minimum > 1) { ?>
