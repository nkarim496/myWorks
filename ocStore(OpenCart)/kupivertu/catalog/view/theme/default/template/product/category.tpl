...
function display(view) {
	if (view == 'list') {
		...
		$('.display').html('<b>Вид:</b> <div id="list_b"></div> <a id="grid_a" onclick="display(\'grid\');">Grid</a>');
		...
		$('.display').html('<b>Вид:</b> <a id="list_a" onclick="display(\'list\');">List</a>  <div id="grid_b"></div>');
