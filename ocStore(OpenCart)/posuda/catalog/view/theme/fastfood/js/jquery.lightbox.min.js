    ...
    $.fn.lightbox = function (options) {
        ...
        var plugin = {
                ...
                if (!plugin.lightbox) {
                    ...
                    if(plugin.lightbox.length === 0){
                        $('body').append(
						  ...
						  '<a href="#" class="lightbox__close lightbox__button"><i class="fa fa-times close"></i></a>' +
                          '<a href="#" class="lightbox__nav lightbox__nav--prev lightbox__button"><i class="fa fa-chevron-left"></i></a>' +
                          '<a href="#" class="lightbox__nav lightbox__nav--next lightbox__button"><i class="fa fa-chevron-right"></i></a>' +
            ...
            bindEvents: function () {
                ...
                // Previous click
                $('.lightbox__nav--prev').on('click', function () {
                    plugin.previous();
                    return false;
                });
