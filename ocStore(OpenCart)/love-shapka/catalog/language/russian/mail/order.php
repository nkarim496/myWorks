...
$_['text_new_greeting']         = 'Благодарим вас за интерес к товарам %s. Оплата производится на номер карты <strong>4276 6000 1061 7039.</strong> Ваш заказ будет обработан после подтверждения оплаты.';
