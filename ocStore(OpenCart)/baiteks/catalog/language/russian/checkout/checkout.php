...
$_['text_checkout_option']           = '<span class="step">Шаг 1:</span> Способ оформления заказа';
$_['text_checkout_account']          = '<span class="step">Шаг 2:</span> Профиль &amp; Платежная информация';
$_['text_checkout_payment_address']  = '<span class="step">Шаг 2:</span> Платежная информация';
$_['text_checkout_shipping_address'] = '<span class="step">Шаг 3:</span> Адрес доставки';
$_['text_checkout_shipping_method']  = '<span class="step">Шаг 4:</span> Способ доставки';
$_['text_checkout_payment_method']   = '<span class="step">Шаг 5:</span> Способ оплаты';
$_['text_checkout_confirm']          = '<span class="step">Шаг 6:</span> Подтверждение заказа';
