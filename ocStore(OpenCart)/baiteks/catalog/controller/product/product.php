...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			$this->data['text_otzv'] = $this->language->get('text_otzv');
			...
			if ($product_info['image']) {
				...
				$this->data['thumbadditional'] = $this->model_tool_image->resize('no_image.jpg', $this->config->get('config_image_additional_width'), $this->config->get('config_image_additional_height'));
			}

			if($product_info['man_img']){
			    $this->data['man_img']=$this->model_tool_image->resize($product_info['man_img'],120,80);
			} else {
				$this->data['man_img'] = '';
			}
			...
			if ((float)$product_info['special']) {
				$this->data['saving'] = ((float)$product_info['price'] ? round((($product_info['price'] - $product_info['special'])/$product_info['price'])*100, 0) : 0);
