...
<div class="category-details">
  ...
  <table class="compare-info">
    ...
    <tr>
      ...
      <?php foreach ($products as $product) { ?>
      <td>
	<a class="button" title="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" /><i class="fa fa-shopping-cart fa-2x"></i></a>
	<a href="<?php echo $product['remove']; ?>" class="button" title="<?php echo $button_remove; ?>"><i class="fa fa-trash-o fa-2x"></i></a>
      </td>
      <?php } ?>
    </tr>
