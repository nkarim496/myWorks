...
<div class="category-details-top"><div class="category-h1">
  ...
  <div class="buttons">
    <div class="right"><a href="<?php echo $checkout; ?>" class="button"><i class="fa fa-check"></i><?php echo $button_checkout; ?></a></div>
    <div class="left"><a href="<?php echo $continue; ?>" class="button"><i class="fa fa-reply"></i><?php echo $button_shopping; ?></a></div>
  </div>
