        ...
        <table id="images" class="list">
          ...
          <tbody class="MoveableRow" id="image-row<?php echo $image_row; ?>">
            <tr>
              ...
              <td class="left"><a onclick="$('#image-row<?php echo $image_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a><a class="down_button button"><b>&darr;</b</a><a class="up_button button"><b>&uarr;</b</a></td>
            </tr>
          </tbody>
          <?php $image_row++; ?>
          <?php } ?>
...
function addImage() {
	...
	html += '<td class="left"><a onclick="$(\'#image-row' + image_row  + '\').remove();" class="button"><?php echo $button_remove; ?></a><a class="down_button button"><b>&darr;</b</a><a class="up_button button"><b>&uarr;</b></a></td>';
	html += '</tr>';
	html += '</tbody>'; 
