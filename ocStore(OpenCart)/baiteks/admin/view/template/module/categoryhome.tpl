    ...
    <table id="module" class="list">
      ...
      <?php $module_row = 0; ?>
        ...
        <tr>
            ...
            <td><input name="categoryhome_category" type="radio" value="0" <?php if($categoryhome_category==0 || $categoryhome_category='' ){?>checked<?php } ?> /><?php echo $text_rootcategory; ?><br/><br/>
