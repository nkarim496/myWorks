...
function emailFormSubmission()
{
	...
	$subject = 'Отправка Алибек Заказ обратного звонка Подвал';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Представьтесь:</b></td><td>' . htmlentities($_REQUEST["custom_U2541"],ENT_COMPAT,'UTF-8') . '</td></tr>';
