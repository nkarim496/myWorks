...
function emailFormSubmission()
{
	...
	$subject = 'Отправка Алибек Забронировать номер Визбор';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Представьтесь:</b></td><td>' . htmlentities($_REQUEST["custom_U2580"],ENT_COMPAT,'UTF-8') . '</td></tr>';
