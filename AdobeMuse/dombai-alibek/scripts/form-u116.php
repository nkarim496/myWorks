...
{
	$to = 'dombai-alibek@mail.ru';
	$subject = 'Отправка Алибек Забронировать номер Главный захват';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Представьтесь:</b></td><td>' . htmlentities($_REQUEST["custom_U126"],ENT_COMPAT,'UTF-8') . '</td></tr>';
