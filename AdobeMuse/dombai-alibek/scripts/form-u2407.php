...
function emailFormSubmission()
{
	...
	$subject = 'Отправка Алибек Забронировать номер Подвал';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Представьтесь:</b></td><td>' . htmlentities($_REQUEST["custom_U2419"],ENT_COMPAT,'UTF-8') . '</td></tr>';
