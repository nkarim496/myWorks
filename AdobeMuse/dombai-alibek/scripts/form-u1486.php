...
function emailFormSubmission()
{
	...
	$subject = 'Отправка Алибек забронировать КОТТЕДЖИ';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Представьтесь:</b></td><td>' . htmlentities($_REQUEST["custom_U1487"],ENT_COMPAT,'UTF-8') . '</td></tr>';
