...
{
	$to = '';
	$subject = 'Отправка Форма Гостиничный комплекс "Алибек"';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Представьтесь:</b></td><td>' . htmlentities($_REQUEST["custom_U318"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Номер телефона:</b></td><td>' . htmlentities($_REQUEST["Email"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Когда перезвонить?:</b></td><td>' . htmlentities($_REQUEST["custom_U326"],ENT_COMPAT,'UTF-8') . '</td></tr>';
