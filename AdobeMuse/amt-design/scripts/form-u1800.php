...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Пользовательский текст::</b></td><td>' . htmlentities($_REQUEST["custom_U1823"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Сотовый телефон:</b></td><td>' . htmlentities($_REQUEST["custom_U1817"],ENT_COMPAT,'UTF-8') . '</td></tr>';
