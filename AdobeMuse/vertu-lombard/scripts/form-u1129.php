...
{
	$to = 'admin@vertu-lombard.ru,ak-kala@mail.ru,islamlaipanov@gmail.com';
	$subject = 'Отправка Форма Продать Vertu';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Представьтесь:</b></td><td>' . htmlentities($_REQUEST["custom_U1143"],ENT_COMPAT,'UTF-8') . '</td></tr>';
