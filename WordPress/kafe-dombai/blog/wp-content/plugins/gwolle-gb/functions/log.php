...
function gwolle_gb_get_log_entries( $entry_id ) {
	...
	$log_messages = array(
		...
		'marked-by-honeypot'          => __('Entry marked by the Honeypot.', 'gwolle-gb'),
		'marked-by-nonce'             => __('Entry marked by invalid Nonce.', 'gwolle-gb'),
		'marked-by-akismet'           => __('Entry marked by Akismet.', 'gwolle-gb'),
		'marked-by-longtext'          => __('Entry marked for too long text.', 'gwolle-gb'),
