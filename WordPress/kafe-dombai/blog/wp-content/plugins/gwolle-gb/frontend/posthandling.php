...
function gwolle_gb_frontend_posthandling() {
	...
	if ( isset($_POST['gwolle_gb_function']) && $_POST['gwolle_gb_function'] == 'add_entry' ) {
		...
		// Debug info:
		// gwolle_gb_add_message( '<p class="debug"><strong>Debug info; Moderation: ' . get_option('gwolle_gb-moderate-entries', 'true') . ', Checked: ' . $entry->get_ischecked() . '</strong></p>', false, false );
