...
function gwolle_gb_adminmenu() {
	...
	add_submenu_page( GWOLLE_GB_FOLDER . '/gwolle-gb.php', __('Entry editor', 'gwolle-gb'), __('Add/Edit entry', 'gwolle-gb'), 'moderate_comments', GWOLLE_GB_FOLDER . '/editor.php', 'gwolle_gb_page_editor' );
...
function gwolle_gb_register() {
	...
	$dataToBePassed = array(
		...
		'load_message' => __('Loading more...', 'gwolle-gb'),
		'end_message'  => __('No more entries.', 'gwolle-gb')
	);
...
function gwolle_gb_admin_bar_menu( $wp_admin_bar ) {
	...
	if ( $count_unchecked > 0 ) {
		...
		$title = '<span id="ab-unchecked-entries" class="ab-label awaiting-mod pending-count count-' . $count_unchecked . '">' . $count_unchecked_i18n . '</span>';
